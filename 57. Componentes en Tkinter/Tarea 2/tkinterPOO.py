...
class TkinterPOO(tk.Tk):
    
    def __init__(self):
        super().__init__()
        self.geometry('800x800')
        self.title('Hola soy una ventana ja')
        self.imagen = tk.PhotoImage(file="57. Componentes en Tkinter\Tarea 1\Cheryl.png")
    ...
    def _componentes_tabulador4(self, tabulador):
        ...
        label = Label(image=self.imagen)
        label.pack()
        boton_imagen = ttk.Button(tabulador, image=self.imagen, command=info)
